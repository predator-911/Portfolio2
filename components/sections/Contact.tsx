                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    <ContactItem
                      ...
                      title="Email"
                      content="sharmalakshay0911@gmail.com"
                      link="mailto:sharmalakshay0911@gmail.com"
                    />
                    <ContactItem
                      icon={<Phone className="h-5 w-5 text-primary" />}
                      title="Phone"
                      content="+91 9958677429"
                      link="tel:+919958677429"
                    />
                    <ContactItem
                      icon={<MapPin className="h-5 w-5 text-primary" />}
                      title="Location"
                      content="Gautam Buddha Nagar, Uttar Pradesh, India"
                    />
                  </div>
